...
(function (factory) {
    ...
    var Tokenfield = function (element, options) {
        ...
        this.$input = $('<textarea type="' + this.options.inputType + '" class="token-input" autocomplete="off" />')
        ...
        (function () {
            ...
            el.on('keyup input focus', function () {
                resizeTextarea(el);
    ...
    Tokenfield.prototype = {
        ...
        , copyToken: function ($token, e) {
            var _self = this
            var text = $token.find('span.token-label').text();
            if (text && text !== '') {
        ...
        , createToken: function (attrs, triggerChange) {
            ...
            $token
                    ...
                    .on('click', function (e) {
                        ...
                        if (e.which === 2) { // middle click, windows-useless
                            e.preventDefault();
                            _self.copyToken($token, e);
                        }
        ...
        , keydown: function (e) {
            ...
            switch (e.keyCode) {
                ...
                case 27: //esc
                    e.preventDefault();
                    _self.$input.parent().find('.token.active').find('span.token-label').text('');
                    _self.unedit();
                    return false;
                    break
                ...
                case 45: // insert
                    (function () {
                        try {
                            var $tkn = _self.$input.parent().find('.token.active');
                            if (!$tkn.size())
                                return
                            _self.copyToken($tkn, e);
                            setTimeout(function () {
                                _self.$input.parent().find('.token:last').dblclick().focus();
                            }, 50);
                        } catch (e) {
                        }
                    })();
